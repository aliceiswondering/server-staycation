...
mongoose.connect("mongodb://127.0.0.1:27017/db_staycation").then(() => {
  ...
  seeder.clearModels(
    ...
    function (err) {
      ...
      seeder.populateModels(data, function (err) {
        if (err) {
          console.error("Error populating models:", err);
          return;
        }
    ...
    documents: [
      // Tabby Town
      {
        ...
        imageId: [
          ...
          // done
          { _id: "5e96cbe292b97300fc90cdb2" },
          // done
          { _id: "5e96cbe292b97300fc90cdb3" },
        ],
        featureId: [
          // done
          { _id: "5e96cbe292b97300fc90aa09" },
          // done
          { _id: "5e96cbe292b97300fc90aa10" },
          // done
          { _id: "5e96cbe292b97300fc90aa11" },
          // done
          { _id: "5e96cbe292b97300fc90aa12" },
          // done
          { _id: "5e96cbe292b97300fc90aa13" },
          // done
          { _id: "5e96cbe292b97300fc90aa14" },
          // done
          { _id: "5e96cbe292b97300fc90aa15" },
          // done
          { _id: "5e96cbe292b97300fc90aa16" },
        ],
        activityId: [
          { _id: "5e96cbe292b97300fc90bb05" },
          { _id: "5e96cbe292b97300fc90bb06" },
          { _id: "5e96cbe292b97300fc90bb07" },
          { _id: "5e96cbe292b97300fc90bb08" },
        ],
      ...
      // Seattle Rain
      {
        ...
        imageId: [
          // done
          { _id: "5e96cbe292b97300fc90cdb4" },
          // done
          { _id: "5e96cbe292b97300fc90cdb5" },
          // done
          { _id: "5e96cbe292b97300fc90cdb6" },
        ],
        featureId: [
          // done
          { _id: "5e96cbe292b97300fc90aa01" },
          // done
          { _id: "5e96cbe292b97300fc90aa02" },
          // done
          { _id: "5e96cbe292b97300fc90aa03" },
          // done
          { _id: "5e96cbe292b97300fc90aa04" },
          // done
          { _id: "5e96cbe292b97300fc90aa05" },
          // done
          { _id: "5e96cbe292b97300fc90aa06" },
          // done
          { _id: "5e96cbe292b97300fc90aa07" },
          // done
          { _id: "5e96cbe292b97300fc90aa08" },
        ],
        activityId: [
          { _id: "5e96cbe292b97300fc90bb01" },
          { _id: "5e96cbe292b97300fc90bb02" },
          { _id: "5e96cbe292b97300fc90bb03" },
          { _id: "5e96cbe292b97300fc90bb04" },
        ],
        categoryId: "5e96cbe292b97300fc901111",
      },
      ...
      // Wodden Pit
      {
        ...
        imageId: [
          // done
          { _id: "5e96cbe292b97300fc90cdb7" },
          // done
          { _id: "5e96cbe292b97300fc90cdb8" },
          // done
          { _id: "5e96cbe292b97300fc90cdb9" },
        ],
        featureId: [
          // done
          { _id: "5e96cbe292b97300fc90aa01" },
      ...
      // Anggana
      {
        ...
        imageId: [
          // done
          { _id: "5e96cbe292b97300fc90cd10" },
          // done
          { _id: "5e96cbe292b97300fc90cd11" },
          // done
          { _id: "5e96cbe292b97300fc90cd12" },
        ],
        featureId: [
          // done
          { _id: "5e96cbe292b97300fc90aa01" },
      ...
      // Green Park
      {
        ...
        imageId: [
          // done
          { _id: "5e96cbe292b97300fc90cd13" },
          // done
          { _id: "5e96cbe292b97300fc90cd14" },
          // done
          { _id: "5e96cbe292b97300fc90cd15" },
        ],
        featureId: [
          // done
          { _id: "5e96cbe292b97300fc90aa01" },
      ...
      // Podo Wae
      {
        ...
        imageId: [
          // done
          { _id: "5e96cbe292b97300fc90cd16" },
          // done
          { _id: "5e96cbe292b97300fc90cd17" },
          // done
          { _id: "5e96cbe292b97300fc90cd18" },
        ],
        featureId: [
          // done
          { _id: "5e96cbe292b97300fc90aa01" },
      ...
      // Silver Rain
      {
        ...
        imageId: [
          // done
          { _id: "5e96cbe292b97300fc90cd19" },
          // done
          { _id: "5e96cbe292b97300fc90cd20" },
          // done
          { _id: "5e96cbe292b97300fc90cd21" },
        ],
        featureId: [
          // done
          { _id: "5e96cbe292b97300fc90aa01" },
      ...
      // Cashville
      {
        ...
        imageId: [
          // done
          { _id: "5e96cbe292b97300fc90cd22" },
          // done
          { _id: "5e96cbe292b97300fc90cd23" },
          // done
          { _id: "5e96cbe292b97300fc90cd24" },
        ],
        featureId: [
          // done
          { _id: "5e96cbe292b97300fc90aa01" },
      ...
      // PS Wood
      {
        ...
        imageId: [
          // done
          { _id: "5e96cbe292b97300fc90cd25" },
          // done
          { _id: "5e96cbe292b97300fc90cd26" },
          // done
          { _id: "5e96cbe292b97300fc90cd27" },
        ],
        featureId: [
          // done
          { _id: "5e96cbe292b97300fc90aa01" },
      ...
      // One Five
      {
        ...
        imageId: [
          // done
          { _id: "5e96cbe292b97300fc90cd28" },
          // done
          { _id: "5e96cbe292b97300fc90cd29" },
          // done
          { _id: "5e96cbe292b97300fc90cd30" },
        ],
        featureId: [
          // done
          { _id: "5e96cbe292b97300fc90aa01" },
      ...
      // Minimal
      {
        ...
        imageId: [
          // done
          { _id: "5e96cbe292b97300fc90cd32" },
          // done
          { _id: "5e96cbe292b97300fc90cd31" },
          // done
          { _id: "5e96cbe292b97300fc90cd33" },
        ],
        featureId: [
          // done
          { _id: "5e96cbe292b97300fc90aa01" },
      ...
      // Stays Home
      {
        ...
        unit: "night",
        imageId: [
          { _id: "5e96cbe292b97300fc90cd36" },
          // done
          { _id: "5e96cbe292b97300fc90cd34" },
          // done
          { _id: "5e96cbe292b97300fc90cd35" },
          // done
        ],
        featureId: [
          // done
    ...
    documents: [
      {
        ...
        total: 12,
        memberId: "5e96cbe292b97300fc903333",
